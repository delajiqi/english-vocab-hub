...
分级**完全按人教版（PEP）教材逐册划分**（数据来自 [kajweb/dict](https://github.com/kajweb/dict)），
所以每个年级与课本单元一一对应：

| 等级代码 | 说明 | 单词数量 | 对应教材 |
|---------|------|--------|--------|
| `Primary`  | 小学      | 819   | 人教版小学 3~6 年级 |
| `Junior-1` | 初一      | 445   | 七年级 上+下 |
| `Junior-2` | 初二      | 762   | 八年级 上+下 |
| `Junior-3` | 初三      | 489   | 九年级 全册 |
| `Senior-1` | 高一      | 498   | 必修 1、2 |
| `Senior-2` | 高二      | 895   | 必修 3、4、5 |
| `Senior-3` | 高三      | 1772  | 选修 6~11 |

**初高中合计：约 5,680 个单词（零重复，每词带音标/词性/例句/真人发音）。**

另外还附带考试词库（数据同源）：
`CET-4 (3739)`、`CET-6 (2078)`、`考研 (4533)`、`TOEFL (9212)`、`SAT (4423)`。
...
- **人教版（PEP）逐册教材词表**——经由 [kajweb/dict](https://github.com/kajweb/dict)
  开源词库整理，含音标、词性、中文释义、例句及发音参数
- 真人/神经网络发音：[有道词典 dictvoice](https://dict.youdao.com/dictvoice)
- 词频参考：COCA 20000、Google 10000（用于早期的频率分级，现已改为按教材分级）
- 教材原始 PDF 可在「国家中小学智慧教育平台」获取

> 详细的分级实现、脚本说明与数据管线见 [DEVELOPER_NOTES.md](DEVELOPER_NOTES.md)。
